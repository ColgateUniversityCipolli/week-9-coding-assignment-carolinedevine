...
\hldef{llgamma} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{par}\hldef{,} \hlkwc{data}\hldef{,} \hlkwc{neg}\hldef{=F)\{}
  \hldef{alpha} \hlkwb{<-} \hlkwd{exp}\hldef{(par[}\hlnum{1}\hldef{])} \hlcom{# go from (-inf,inf) to (0,inf)}
  \hldef{beta} \hlkwb{<-} \hlkwd{exp}\hldef{(par[}\hlnum{2}\hldef{])} \hlcom{# go from (-inf,inf) to (0,inf)}
...
\hldef{(hat.alpha} \hlkwb{<-} \hldef{MLEs.gamma}\hlopt{$}\hldef{par[}\hlnum{1}\hldef{])}
\end{alltt}
\begin{verbatim}
## [1] 1.429383
\end{verbatim}
\begin{alltt}
\hldef{(hat.beta} \hlkwb{<-} \hldef{MLEs.gamma}\hlopt{$}\hldef{par[}\hlnum{2}\hldef{])}
\end{alltt}
\begin{verbatim}
## [1] -0.1736464
\end{verbatim}
...
\end{verbatim}
\begin{alltt}
\hldef{(hat.sigma} \hlkwb{<-} \hldef{MLEs.lnorm}\hlopt{$}\hldef{par[}\hlnum{2}\hldef{])}
\end{alltt}
\begin{verbatim}
## [1] 0.5333417
\end{verbatim}
